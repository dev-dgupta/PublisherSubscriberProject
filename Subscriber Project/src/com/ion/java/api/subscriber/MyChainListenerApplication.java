 ...
 */
public class MyChainListenerApplication implements MkvChainListener, MkvPlatformListener, MkvPublishListener, MkvRecordListener, MkvAvailabilityListener {
...
// records matching this pattern
                ((MkvPattern) mkvObject).subscribe(new String[]{"BID", "ASK"}, new MyChainListenerApplication());
            } catch (Exception e) {
//
            }
        }
...
// install the platform listener
        qos.setPlatformListeners(new MkvPlatformListener[]{new MyChainListenerApplication()});
        try {
