package com.ion.java.api.chain.pattern;
 ...
 */
public class MySupplyChainPatternApplication implements MkvPlatformListener, MkvPublishListener {
    ...
    public static void main(String[] args) {
        ...
        qos.setPlatformListeners(new MkvPlatformListener[]{new MySupplyChainPatternApplication()});
        try {
